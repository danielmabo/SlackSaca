...
class User(models.Model):
    ...
    in_team = models.ForeignKey(Team, primary_key=True, related_name = 'team_id+') #Referencia a qué equipo pertenece (?)
...
class Question(models.Model):
    ...
    asked = models.ForeignKey(User, related_name = 'knows+') #Quién ha preguntado
